 ...
 * PetCareGUI.java
 *
 * This class provides the graphical user interface for the
...
public class PetCareGUI extends JFrame {
     ...
     * Parameters: none
     * Return: none
     * Purpose: Creates and displays the main GUI window.
     */
    public PetCareGUI() {
     ...
     * Parameters: none
     * Return: JPanel
     * Purpose: Creates the title and navigation-button area.
     */
    private JPanel createHeaderPanel() {
        ...
        updateButton.addActionListener(event -> showUpdatePetDialog());

        removeButton.addActionListener(event -> removeSelectedPet());

        healthButton.addActionListener(event -> showHealthSummary());
     ...
     * Parameters: none
     * Return: JScrollPane
     * Purpose: Creates the table used to display pet records.
     */
    private JScrollPane createTablePanel() {
        ...
        petTable.setDefaultRenderer(Object.class, new DefaultTableCellRenderer() {
            @Override
        ...
        petTable.setFont(new Font("SansSerif", Font.PLAIN, 13));
        ...
        petTable.getColumnModel().getColumn(0).setPreferredWidth(65);
        petTable.getColumnModel().getColumn(1).setPreferredWidth(120);
        petTable.getColumnModel().getColumn(2).setPreferredWidth(90);
        petTable.getColumnModel().getColumn(3).setPreferredWidth(130);
        petTable.getColumnModel().getColumn(4).setPreferredWidth(115);
        petTable.getColumnModel().getColumn(5).setPreferredWidth(75);
        petTable.getColumnModel().getColumn(6).setPreferredWidth(210);
        petTable.getColumnModel().getColumn(7).setPreferredWidth(150);
        petTable.getColumnModel().getColumn(8).setPreferredWidth(110);
        petTable.getColumnModel().getColumn(9).setPreferredWidth(350);
     ...
     * Parameters: none
     * Return: void
     * Purpose: Allows the user to select and load a pet-record text file.
     */
    private void loadRecords() {
        ...
        if (!selectedFile.getName().toLowerCase().endsWith(".txt")) {
            ...
            statusLabel.setText("Invalid file type selected.");
            return;
        }
        ...
        if (loaded && !petManager.getPets().isEmpty()) {
            ...
            JOptionPane.showMessageDialog(
                    this,
                    "Pet records were loaded successfully.",
                    "File Loaded",
                    JOptionPane.INFORMATION_MESSAGE
            );

            statusLabel.setText(
                    petManager.getPets().size() +
                            " pet records loaded."
            );
        } else {
            JOptionPane.showMessageDialog(
            ...
            statusLabel.setText("The file could not be loaded.");
        }
    }

    /**
     * Method: refreshPetTable
     * Parameters: none
     * Return: void
     * Purpose: Displays all current pet records in the GUI table.
     */
     ...
     * Parameters: pet
     * Return: String
     * Purpose: Formats the pet's age using years and months.
     */
     ...
     * Parameters: none
     * Return: void
     * Purpose: Confirms whether the user wants to close the application.
     */
    private void exitApplication() {
        ...
        /**
         * Method: showAddPetDialog
         * Parameters: none
         * Return: none
         * Purpose: Displays a form that allows the user to add a new pet record.
         */
    ...
    /**
     * Allows the user to update the selected pet record.
     */
    ...
    /**
     * Method: removeSelectedPet
     * Parameters: none
     * Return: none
     * Purpose: Removes the pet selected in the table after confirmation.
     */
    ...
    /**
     * Method: showHealthSummary
     * Parameters: none
     * Return: void
     * Purpose: Displays a health summary and calculated health score
     ...
     * Parameters: score
     * Return: String
     * Purpose: Returns a written assessment for the calculated health score.
     */
    ...
    /**
     * Method: formatOptionalValue
     * Parameters: value
     * Return: String
     * Purpose: Displays None when an optional pet field is blank.
     */
